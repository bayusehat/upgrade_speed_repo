    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-12">
                <a href="{{ url('oplang/mola') }}" class="btn btn-danger btn-sm float-right"><i class="fas fa-arrow-left"></i> Kembali ke Data Oplang</a>
            </div>
        </div>
        <hr>
        @if(session('success'))
        ...
        @endif
        <form action="{{ url('oplang/mola/update/'.$data[0]->id) }}" method="post">
            @csrf
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm border-bottom" value="{{ $data[0]->no_hp }}" disabled>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm border-bottom" value="{{ $data[0]->nama }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="nd_pots"><strong>E-MAIL :</strong></label>
                                    <input type="text" class="form-control form-control-sm border-bottom" value="{{ $data[0]->email }}" disabled>
                                </div>
                                <div class="form-group">
